...
import com.appentus.camscanner.adapter.ColorEffectAdapter;
import com.appentus.camscanner.adapter.ColorFilterAdapter;
import com.appentus.camscanner.adapter.EditToolsAdapter;
import com.appentus.camscanner.adapter.FontAdapter;
import com.appentus.camscanner.adapter.OverlayAdapter;
import com.appentus.camscanner.adapter.SignatureAdapter;
import com.appentus.camscanner.adapter.WatermarkFontAdapter;
import com.appentus.camscanner.db.DBHelper;
import com.appentus.camscanner.document_view.ColorFilter;
import com.appentus.camscanner.main_utils.AdjustUtil;
import com.appentus.camscanner.main_utils.BitmapUtils;
...
//        editText.setTextColor(defaultTxtColor);
    ...
    private void setupSticker() {
        BitmapStickerIcon bitmapStickerIcon = new BitmapStickerIcon(ContextCompat.getDrawable(this, R.drawable.new_sticker_delete), 0);
        bitmapStickerIcon.setIconEvent(new DeleteIconEvent());
        BitmapStickerIcon bitmapStickerIcon2 = new BitmapStickerIcon(ContextCompat.getDrawable(this, R.drawable.new_sticker_rotate), 3);

        bitmapStickerIcon2.setIconEvent(new ZoomIconEvent());
        BitmapStickerIcon bitmapStickerIcon3 = new BitmapStickerIcon(ContextCompat.getDrawable(this, R.drawable.new_sticker_flip), 1);
